...
<form action="{{ url('/AnexoClausula/'.$dato->id_anexo.'/anadirClausula') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-md-12 center12313123" >
                        <input class= "btn btn-sm btn-primary add " type ="button" name ="add" id="add" value = "Añadir otra fila de clausula" >
               
                        <input class= "btn btn-sm btn-secondary addclausula " type ="button" name ="addclausula" id="addclausula" value = "Agregar clausula al formulario" >
                    </div>
                </div>

                <input type="submit" name="submit" class="btn btn-success" value="Agregar clausulas a anexo" />
                <a href="{{ url('/home') }} " class="button btn btn-secondary " type="button" >Inicio</a> 
            </div>
        </div>
    </form>
@endsection
