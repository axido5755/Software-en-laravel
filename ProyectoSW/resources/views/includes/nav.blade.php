...
$data = http::get('http://146.83.194.142:1042/api/users/?rut='.$request->rut.'&password='.$request->contrasena)->json();
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="form-inline position-relative d-inline-block my-2">
                    <input class="form-control" name="search" id="search" type="search" placeholder="Buscar" aria-label="Buscar">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        Usuario
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/usuario"><i class="fas fa-user"></i> Mi perfil</a>
                                
                            <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/Login"><i class="fas fa-sign-out-alt"></i> Cerrar sesión</a>
                            </div>
                    </li>
                </ul>
                </div>
